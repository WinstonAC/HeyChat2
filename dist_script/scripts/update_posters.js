...
const supabaseClient_1 = require("../lib/supabaseClient"); // Relative and extensionless for tsc
...
if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) {
    console.error('Error: Supabase environment variables (NEXT_PUBLIC_SUPABASE_URL, NEXT_PUBLIC_SUPABASE_ANON_KEY) are not set. Ensure they are in .env.local');
    process.exit(1);
}
...
async function updatePoster(id, url) {
