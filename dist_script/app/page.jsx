...
export default function HomePage() {
    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      {error && (<div className="text-center p-4 bg-red-900 border border-red-700 rounded-md">
      ...
      {!loading && !error && shows.length === 0 && (<div className="text-center">
      ...
      {!loading && !error && shows.length > 0 && (<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
